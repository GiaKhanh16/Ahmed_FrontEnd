      ...
      <BackgroundLines className="flex flex-col w-full min-h-screen px-4">
        ...
        <div className="flex-1 flex flex-col items-center justify-center md:gap-45 lg:gap-45">
          <div className="text-center">
            <h2 className="bg-clip-text text-transparent bg-gradient-to-b  from-neutral-600 to-white  md:text-4xl lg:text-7xl font-sans md:py-5 relative z-20 font-bold tracking-tight text-6xl pb-3">
